...
class RobotContainer {
 public:
  ...
  std::unordered_map<std::string, std::tuple<std::function<void(double, double, double, double)>, frc2::Subsystem*, COMETS3357::Controller::JoystickCommandMode>> joystickActionMap
  {
   ...
   {"ManualElevator", {[this](auto leftX, auto leftY, auto rightX, auto rightY){elevator.SetPercent(leftY);}, &elevator, COMETS3357::Controller::JoystickCommandMode::JOYSTICK_DEADZONE_COMMAND}}
  };
